...
(function initModal() {
  ...
  const projectData = {
    projectAceBank: {
      icon: '🏦',
      title: 'Ace Bank — Online Banking Management System',
      tech: [
        { label: 'Java', cls: 'tech-badge--java' },
        { label: 'Servlets', cls: '' },
        { label: 'JDBC', cls: '' },
        { label: 'MySQL', cls: 'tech-badge--db' },
        { label: 'HTML/CSS/JS', cls: 'tech-badge--web' },
        { label: 'Maven', cls: '' },
        { label: 'MVC Architecture', cls: '' },
        { label: 'Lombok', cls: '' },
      ],
      description: 'A full-stack banking web application designed to manage bank users, accounts, transactions, and authentication digitally through secure login and user dashboards. The system allows users to perform banking operations such as viewing account details, transaction history, and managing financial activities through a web interface.',
      highlights: [
        'Developed a digital banking management platform that automates user account handling and transaction tracking',
        'Implemented secure login authentication, database connectivity using JDBC, and structured MVC architecture',
        'Provides an organized interface for users to view account information and transaction records efficiently',
        'Backend structured with Java Servlets, following MVC patterns for maintainability',
      ],
      date: '2024',
      github: 'https://github.com/Extensiblegithub/Ace-Bank-lite.git',
    },
    projectRideMyCar: {
      icon: '🚗',
      title: 'Ride My Car — Vehicle Rental Web Application',
      tech: [
        { label: 'HTML', cls: 'tech-badge--web' },
        { label: 'CSS', cls: 'tech-badge--web' },
        { label: 'JavaScript', cls: 'tech-badge--web' },
        { label: 'Responsive Design', cls: '' },
        { label: 'Modular UI Components', cls: '' },
      ],
      description: 'A web-based vehicle rental platform designed to allow users to browse, view, and explore available cars and bikes through a responsive and user-friendly interface. The system includes user authentication features such as login and signup to manage user access and improve interaction with the platform.',
      highlights: [
        'Implemented a responsive vehicle rental web platform with structured UI components for car and bike listings',
        'Implemented clean page architecture and reusable design elements to improve navigation and user experience',
        'Optimized frontend development by organizing modular stylesheets and assets',
        'Ensures better maintainability and scalability of the application',
      ],
      date: '2024',
      github: 'https://github.com/Extensiblegithub',
    },
  };
...
(function initContactForm() {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    // Success state
    feedback.textContent = '✅ Message sent! Thank you — Shubham will get back to you soon.';
